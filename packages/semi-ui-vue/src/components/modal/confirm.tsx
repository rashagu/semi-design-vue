...
import { IconAlertCircle, IconAlertTriangle, IconHelpCircle, IconInfoCircle, IconTickCircle } from '@kousum/semi-icons-vue';
...
export default function confirm<T>(props: ConfirmProps) {
    ...
    function render(renderProps: ConfirmProps) {
        vueRender(<ConfirmModal {...renderProps} motion={mergedMotion}/>, div)
    }
