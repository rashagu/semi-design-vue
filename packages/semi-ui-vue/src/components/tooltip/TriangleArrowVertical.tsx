...
const TriangleArrowVertical = defineComponent<ExampleProps>((props, {slots}) => {
  const { className, style, ...restProps } = props;
  return ()=>(
    <svg class={className} style={style} {...restProps} width="7" height="24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
