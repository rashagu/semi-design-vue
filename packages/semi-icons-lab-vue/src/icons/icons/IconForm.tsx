  ...
  return () => (
    ...
    >
      <g clip-path="url(#clip0_1_3028)">
        <rect x={3.051} y={2.888} width={16} height={21} rx={2} transform="rotate(-6 3.05081 2.88827)" fill="#FF7D95" />
        <rect x={5.249} y={4.668} width={12} height={17} rx={1} transform="rotate(-6 5.2489 4.66825)" fill="white" />
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
        ...
        <rect x={8.492} y={16.393} width={3.35025} height={2} transform="rotate(-6 8.49229 16.3935)" fill="#DDE3E8" />
        <path
          d="m20.03 9.95-4.92 4.96c-.1.09-.17.2-.21.31l-.86 2.13c-.16.39.23.77.61.62l2.16-.86a.96.96 0 0 0 .32-.2l4.92-4.97-2.02-2Z"
          fill="#6A6F7F"
        />
        <path d="m22.05 11.94.67-.67a.93.93 0 0 0 0-1.33l-.67-.66a.96.96 0 0 0-1.35 0l-.67.67 2.02 2Z" fill="#6A6F7F" />
      </g>
      <defs>
...
const IconComponent = defineComponent({
  ...
  setup(props, { slots }) {
    return () => (
      <ConvertIcon iconType={'form'} {...props}>
        {{
