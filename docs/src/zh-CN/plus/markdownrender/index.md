...
```jsx
import { MarkdownRender } from '@kousum/semi-ui-vue';
```
...
```jsx live=true dir="column"
import { MarkdownRender, Typography } from '@kousum/semi-ui-vue';
...
```jsx live=true
import { Button, MarkdownRender, Typography } from '@kousum/semi-ui-vue';
