...
import { Switch, Space } from '@kousum/semi-ui-vue';
...
export default () => (
    <div>
        ...
        <Switch checkedText="｜" uncheckedText="〇" style={{ marginLeft: '5px' }} />
        <br />
        <br />
        <Switch defaultChecked checkedText="开" uncheckedText="关" />
        <Switch defaultChecked checkedText="｜" uncheckedText="〇" style={{ marginLeft: '5px' }} />
        <br />
        <br />
        <Switch checkedText="开" uncheckedText="关" size="large" />
        <Switch checkedText="｜" uncheckedText="〇" size="large" style={{ marginLeft: '5px' }} />
        <br />
        <br />
        <Switch defaultChecked checkedText="开" uncheckedText="关" size="large" />
        <Switch defaultChecked checkedText="｜" uncheckedText="〇" size="large" style={{ marginLeft: '5px' }} />
    </div>
);
```
...
const Comp = defineComponent(() => {
  ...
  return ()=>(
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Switch checked={open.value} onChange={(v)=>open.value = v} aria-label="a switch for demo" />
          </div>
  );
})
export default Comp;
...
const Comp = defineComponent(() => {
  ...
  return () => <Switch checked={checked.value} aria-label="a switch for demo" onChange={onChange} />;
})
export default Comp;
```
