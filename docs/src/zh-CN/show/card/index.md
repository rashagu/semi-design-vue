...
const Demo = defineComponent(() => {
  ...
  return () => (
          <>
            <Switch onChange={v => loading.value = (!v)} />
            <br />
            <br />
            <Card
                    style={{ maxWidth: '360px' }}
  ...
  return ()=>(
          <>
            ...
            <Card
                    ...
                    headerExtraContent={
                      <Skeleton style={{ width: '50px' }} placeholder={<Paragraph rows={1} />} loading={loading.value}>
                    ...
                    cover={
                      <Skeleton style={{ maxWidth: '100%', height: '220px' }} placeholder={<Image />} loading={loading.value}>
                        <img
                                alt="example"
                                src="https://lf3-static.bytednsdoc.com/obj/eden-cn/ptlz_zlp/ljhwZthlaukjlkulzlp/root-web-sites/card-cover-docs-demo.jpeg"
                        />
