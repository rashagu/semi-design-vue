...
```jsx live=true dir="column" height="1500"
...
const Demo = defineComponent(() => {
  ...
  return () => (
          <>
            ...
            >
              {visible.value ? 'Hide Banner' : 'Show Banner'}
            </Button>
          </>
  );
})
...
function Demo() {
    ...
    return (
        <div style={{ width: '600px' }} className="components-banner-demo">
