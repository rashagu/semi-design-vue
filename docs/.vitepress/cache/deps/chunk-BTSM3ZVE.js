...
// node_modules/.pnpm/@douyinfe+semi-foundation@2.34.0/node_modules/@douyinfe/semi-foundation/lib/es/form/utils.js
var import_cloneDeep = __toESM(require_cloneDeep());

// node_modules/.pnpm/async-validator@3.5.2/node_modules/async-validator/dist-web/index.js
function _extends() {
...
function isRequired() {
  ...
  } else if (Array.isArray(rules2) && rules2.length) {
    rules2.forEach((rule) => {
...
function mergeProps(props) {
  ...
  let _a = Object.assign(Object.assign({}, defaultProps), props), {
    ...
    pure,
    id
  } = _a, rest = __rest(_a, ["field", "label", "labelPosition", "labelWidth", "labelAlign", "labelCol", "wrapperCol", "initValue", "validate", "validateStatus", "trigger", "allowEmptyString", "allowEmpty", "emptyValue", "rules", "onChange", "keepState", "transform", "name", "fieldClassName", "fieldStyle", "noLabel", "noErrorMessage", "isInInputGroup", "stopValidateWithError", "convert", "showValidateIcon", "helpText", "extraText", "extraTextPosition", "pure", "id"]);
  delete rest.defaultChecked;
  delete rest.defaultValue;
  delete rest.checked;
  if (typeof initValue !== "undefined") {
    initValue = (0, import_cloneDeep.default)(initValue);
  }
...
//# sourceMappingURL=chunk-BTSM3ZVE.js.map
