...
import { Layout, LayoutContent, LayoutHeader, LayoutSider, Nav, Space, Button, Empty } from '@kousum/semi-ui-vue';
...
const headerStyle = computed(() => {
  return isDark.value
    ? { backgroundColor: 'var(--semi-color-bg-0)', borderBottom: '1px solid var(--semi-color-border)' }
    : {};
});
        ...
        <div style="margin: 0 auto; padding-top: 60px">
          <div v-if="page.isNotFound">
            <div style="margin-top: 10vh">
              <Empty
                :image="h(IllustrationConstruction, { style: { width: '150px', height: '150px' } }, [])"
                :darkModeImage="h(IllustrationConstructionDark, { style: { width: '150px', height: '150px' } }, [])"
                title="功能建设中"
...
.semi-overview-list {
  ...
  .semi-overview-card {
    ...
    margin-bottom: 24px;
    cursor: pointer;
    .semi-overview-card-image {
      width: 100%;
      height: 129px;
    }
    .semi-overview-card-text {
      font-size: 14px;
      line-height: 20px;
      margin-top: 4px;
